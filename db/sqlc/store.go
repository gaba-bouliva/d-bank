...
func (store *Store) execTx(ctx context.Context, fn func(*Queries) error) error {
	...
	if err != nil {
		if rbErr := tx.Rollback(); rbErr != nil {
			return fmt.Errorf("db tx err: %v %v", err, rbErr)
		}
...
//TranferTxParams contains the input parameters of the tranfer transaction
...
// It creates a tranfer record, add account entries, and update accountss balance witthin a single db transaction
